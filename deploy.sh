...
az vm run-command invoke -g "${deployment_name}" -n "vm-f5-tut-${env}" --command-id RunShellScript --scripts "git clone 'https://github.com/tomtechnologies/f5_azure_tut.git' ; cd f5_azure_tut ; bash install.sh & ; disown"
