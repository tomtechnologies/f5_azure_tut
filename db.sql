...
use tomtec;
create table user (id int PRIMARY KEY AUTO_INCREMENT, user varchar(255), pass(255), fullname varchar(255));

insert into table (user, pass, fullname) values ('admin', 'pass', 'My Administrator');
insert into table (user, pass, fullname) values ('tom', 'pass', 'Mer');
